...
import { cn } from "@/lib/utils"; // ou substitua por sua própria função de merge de classes
...
const thumbVariants = "pointer-events-none block h-5 w-5 rounded-full bg-background shadow-lg ring-0 transition-transform";
